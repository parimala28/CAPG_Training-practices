...
class Department:
    ...
    def promote(self,employee:Employee,new_role:Employee) -> None:
        
        print(f" The {employee.name } is promoted  to  {type (new_role).__name__}  ")
...
new_developer = Developer("Charlie", 40000)
it_department.promote(intern, new_developer)
